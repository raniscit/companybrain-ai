        ...
        <main className="relative min-h-screen overflow-hidden bg-[#14181C] px-4 py-12 text-[#F1EDE4] sm:px-6 lg:px-8">
            ...
            <div className="mb-8 flex justify-end">
                <SignOutButton redirectUrl="/">
                    <button className="rounded-lg bg-[#5FD4C4] px-4 py-2 text-sm text-white transition hover:bg-red-400">
                        Logout
                    </button>
                </SignOutButton>
            </div>
                ...
                <div className="stamp-in fixed right-5 top-5 z-50 w-[calc(100%-2.5rem)] max-w-md rounded-lg border border-[#D9A44C]/40 bg-[#1C2126] p-4 shadow-2xl shadow-black/40">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="font-mono text-xs uppercase tracking-[0.2em] text-[#D9A44C]">
                                Filed to archive
                            </p>

                            <p className="mt-1 text-sm leading-6 text-[#9099A3]">
                                {uploadMessage}
                            </p>
                        </div>
            ...
            <div className="relative z-10 mx-auto max-w-5xl">
                ...
                <div className="mb-14 text-center">
                    ...
                    <h1 className="reveal reveal-delay-1 font-serif text-4xl font-semibold tracking-tight text-[#F1EDE4] sm:text-5xl lg:text-6xl">
                        CompanyBrain
                    </h1>
                    ...
                    {/* FIXED: smaller description */}
                    <p className="reveal reveal-delay-3 mx-auto mt-6 max-w-xl text-base leading-relaxed text-[#9099A3] sm:text-lg">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <section className="card-rise card-rise-1 group relative rounded-2xl border border-[#2A2F36] bg-[#1C2126] p-7 shadow-xl shadow-black/20 transition-all duration-300 hover:-translate-y-1 hover:border-[#D9A44C]/40 hover:shadow-2xl hover:shadow-[#D9A44C]/5">
                        ...
                        <div className="mb-6 mt-2">
                            ...
                            <p className="mt-1.5 text-sm text-[#9099A3]">
                        ...
                        <div className="mt-5">
                            ...
                            <label
                                htmlFor="accessGroup"
                                className="mb-2 block font-mono text-xs uppercase tracking-[0.15em] text-[#9099A3]"
                            >
                            ...
                            <select
                                ...
                                className="w-full rounded-xl border border-[#2A2F36] bg-[#14181C] px-4 py-3 text-sm text-[#F1EDE4] outline-none transition-colors duration-200 focus:border-[#D9A44C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#D9A44C]"
                            >
                        ...
                        <button
                            ...
                            className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-[#D9A44C] px-4 py-3.5 text-base font-medium text-[#14181C] transition-all duration-200 hover:bg-[#E5B565] hover:shadow-lg hover:shadow-[#D9A44C]/20 active:scale-[0.99] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#D9A44C] disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:shadow-none"
                        >
                    ...
                    <section className="card-rise card-rise-2 group relative rounded-2xl border border-[#2A2F36] bg-[#1C2126] p-7 shadow-xl shadow-black/20 transition-all duration-300 hover:-translate-y-1 hover:border-[#5FD4C4]/40 hover:shadow-2xl hover:shadow-[#5FD4C4]/5">
                        ...
                        <form onSubmit={handleQuery}>
                            ...
                            <textarea
                                ...
                                rows={5}
                                className="w-full resize-none rounded-xl border border-[#2A2F36] bg-[#14181C] px-4 py-3.5 text-base leading-6 text-[#F1EDE4] outline-none transition-colors duration-200 placeholder:text-[#565D68] focus:border-[#5FD4C4] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#5FD4C4]"
                            />
                    ...
                    <section className="fade-in relative mt-6 overflow-hidden rounded-2xl border border-[#2A2F36] bg-[#1C2126] p-7 shadow-xl shadow-black/20">
                        ...
                        {loading ? (
                            <div className="relative overflow-hidden rounded-xl border border-[#2A2F36] bg-[#14181C] p-5">
                                ...
                                <div className="flex items-center gap-3 text-sm text-[#9099A3]">
                            ...
                            <p className="fade-in whitespace-pre-wrap font-serif text-base leading-7 text-[#DCD7CC] sm:text-lg">
                                {answer}
                            </p>
                        )}
                            ...
                            {sources.map((source, index) => (
                                ...
                                >
                                    ...
                                    <summary className="flex cursor-pointer list-none items-center justify-between px-4 py-3.5 [&::-webkit-details-marker]:hidden">
                                        ...
                                        <span className="flex items-center gap-2 font-mono text-xs uppercase tracking-[0.15em] text-[#D9A44C]">
                                    ...
                                    <div className="border-t border-[#2A2F36] px-4 py-4">
                                        ...
                                        <div className="mb-4 flex flex-wrap gap-3">
                                            ...
                                            <div className="rounded-lg border border-[#2A2F36] bg-[#1C2126] px-3 py-2">
                                            ...
                                            <div className="rounded-lg border border-[#2A2F36] bg-[#1C2126] px-3 py-2">
                                                ...
                                                <p className="mt-1 text-sm font-medium text-[#D9A44C]">
                                                    {source.page_number != null
                                                        ? String(source.page_number)
                                                        : "Unknown"}
                                                </p>
                                        ...
                                        <p className="whitespace-pre-wrap text-sm leading-6 text-[#9099A3]">
                                            {source.content}
                                        </p>
                ...
                <p className="mt-12 text-center font-mono text-xs uppercase tracking-[0.15em] text-[#565D68]">
